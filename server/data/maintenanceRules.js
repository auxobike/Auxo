...
//   tireTracked: true              — mileage base uses the installed tire's miles, and
//                                    service log is stored per-tire so history
//                                    travels when the tire moves to a different bike
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'tire_replace', label: 'Tires',            action: 'Replace',     tireTracked: true, trigger: { type: 'miles', every: 2500 } },
          { id: 'sealant_add',  label: 'Tubeless Sealant', action: 'Add/top up',  tubelessOnly: true, tireTracked: true, trigger: { type: 'days', every: 180 } },
        ],
      },
      {
        id: 'bike',
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'tire_replace', label: 'Tires',           action: 'Replace',    tireTracked: true, trigger: { type: 'miles', every: 1500 } },
          { id: 'sealant_add', label: 'Tubeless Sealant', action: 'Add/top up', tubelessOnly: true, tireTracked: true, trigger: { type: 'days', every: 180 } },
        ],
      },
      {
  ...
  gravel: {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          { id: 'tires_check', label: 'Tires',            action: 'Inspect',    trigger: { type: 'miles', firstAt: 1000, thenEvery: 500 } },
          { id: 'tire_replace', label: 'Tires',           action: 'Replace',    tireTracked: true, trigger: { type: 'miles', every: 2000 } },
          { id: 'sealant_add', label: 'Tubeless Sealant', action: 'Add/top up', tubelessOnly: true, tireTracked: true, trigger: { type: 'days', every: 180 } },
        ],
      },
      {
